...
public class Calendar extends Fragment {
    ...
    private void setupView(View view)
    {
        ...
        ScheduleBusiness scheduleBusiness = new ScheduleBusiness(getActivity());
        scheduleBusiness.getSchedule(this);

        listAdapter = new ExpandableListAdapter(getActivity().getApplicationContext(), listDataHeader, listDataChild, scheduleBusiness.getScheduleBean());
